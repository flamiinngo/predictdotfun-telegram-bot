...
💡 *Pro Tips:*
• Start with `/topwallets` to find sharp bettors
• Use `/market <id>` for full analysis before betting
• Set `/setwhale 50` for more alerts
...
"""
    ...
    def run(self):
        ...
        # Start monitoring in background using asyncio
        async def start_monitoring():
            await self.monitoring_loop(app)
        
        # Schedule monitoring to start after bot initialization
        app.post_init = lambda app: asyncio.create_task(start_monitoring())
